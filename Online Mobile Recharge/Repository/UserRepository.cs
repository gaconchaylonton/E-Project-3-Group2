    ...
    public class UserRepository : IUser
    {
        ...
        public bool Update(int id, User entity)
        {
            ...
            if (!string.IsNullOrEmpty(entity.Name) && !string.IsNullOrEmpty(entity.Address) && entity.Dob != null &&
                RegexManagement.IsValidEmail(entity.Email) && RegexManagement.IsValidPhoneNumber(entity.Phone))
            {
        ...
        public bool ChangePassword(int userId, string newPassword)
        {
            ...
            {
                throw new ArgumentException("A valid password has at least 8 characters, 1 number");
            }
            else
            {
